...
do
  cf unmap-route "test_at_home-prod-$app_number" app.ea.cloud.gov --hostname "test_at_home-prod-$app_number"
  ...
  cf map-route "test_at_home-prod-$app_number" east.covidtest.usa.gov
  cf map-route "test_at_home-prod-$app_number" easta.covidtest.usa.gov
